...
For the vLLM driver outputs (under results_vllm/), pass
  --results-dir benchmarks/w2/results_vllm  --baseline fcfs_apc_lru
"""
...
def main() -> None:
    ...
    ap.add_argument("--results-dir", default=str(W2 / "results"))
    ap.add_argument("--out-dir", default=str(W2))
